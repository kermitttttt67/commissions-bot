...
class OrderView(View):
    def __init__(self, discord_username, product, developer, payment, budget, notes, order_id=None):
        ...
        accept_btn = Button(label="✅ Accept", style=discord.ButtonStyle.success, custom_id=f"accept_{self.order_id}")
        decline_btn = Button(label="❌ Decline", style=discord.ButtonStyle.danger, custom_id=f"decline_{self.order_id}")
